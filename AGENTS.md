...
Проект не использует базу данных и ORM. Контент и настройки хранятся в типизированных
файлах проекта. Не добавлять MySQL, Prisma или другую БД без отдельного прямого запроса
пользователя.
