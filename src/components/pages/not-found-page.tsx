  ...
  return (
    <main id="main" className="py-24">
      <Container>
        ...
        <p className="mb-8 mt-5 text-muted-foreground">
          Возможно, адрес изменился. Перейдите к системам токоподвода или начните с главной.
        </p>
        <div className="flex flex-wrap gap-3">
          <ActionLink href="/">На главную</ActionLink>
          <ActionLink href="/produkciya/" outline>
            Продукция
          </ActionLink>
        </div>
      </Container>
