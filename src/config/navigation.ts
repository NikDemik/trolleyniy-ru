...
export const footerGroups = [
  { title: "Продукция", slugs: ["produkciya/trolleynyy-shinoprovod", "produkciya/monotrolleynyy-shinoprovod", "produkciya/festonnye-sistemy"] },
  { title: "Решения", slugs: ["resheniya/mostovye-krany", "resheniya/kran-balki", "resheniya/elektrotelfery", "resheniya/proizvodstvennye-linii"] },
